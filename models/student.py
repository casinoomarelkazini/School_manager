...
class Student(models.Model):
    ...
    _order = 'name'
 # button_done: When this button is pressed, it updates the state 
 # field of the student record to 'done'. The button_done method 
 # iterates over the selected student records and writes the 'done' 
 # value to their state field.
    ...
    @api.depends('age') # @api.depends('age') decorator on the method.
